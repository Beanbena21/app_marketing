...
import 'package:app_marketing_version_2/widgets/dialog_avatar.dart';
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              InkWell(
                onTap: () => DialogAvatar.diaglogcustom(context,
                    '${context.read<Authenicator>().firebaseAuth.currentUser!.email}'),
